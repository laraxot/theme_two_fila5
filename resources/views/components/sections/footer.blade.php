        ...
        <div class="mt-12 pt-8 border-t border-white/10">
            <div class="text-center mb-6">
                ...
                <div class="flex flex-wrap justify-center gap-4">
                    ...
                    @endif
                    <a href="https://wa.me/39XXXXXXXXXX" target="_blank" class="flex items-center gap-2 px-5 py-3 bg-green-500 hover:bg-green-600 text-white rounded-lg font-semibold transition-all duration-300 hover:scale-105 shadow-lg">
                    ...
                    <a href="/it/pages/contacts" class="flex items-center gap-2 px-5 py-3 bg-orange-500 hover:bg-orange-600 text-white rounded-lg font-semibold transition-all duration-300 hover:scale-105 shadow-lg">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex flex-wrap justify-center items-center gap-6">
                <div class="flex flex-col items-center gap-1 bg-white/5 px-4 py-3 rounded-lg border border-white/10">
                    <div class="flex items-center gap-2 text-orange-400">
                        ...
                        <span class="font-semibold text-sm text-white">Esperto Qualificato Fisica Sanitaria</span>
                    </div>
                ...
                <div class="flex flex-col items-center gap-1 bg-white/5 px-4 py-3 rounded-lg border border-white/10">
                    <div class="flex items-center gap-2 text-orange-400">
                        ...
                        <span class="font-semibold text-sm text-white">Esperto in Radioprotezione</span>
                    </div>
                    <p class="text-xs text-gray-400">Ministero della Salute</p>
                    <p class="text-xs text-gray-500">Valido fino a: 2026-12-31</p>
                </div>
