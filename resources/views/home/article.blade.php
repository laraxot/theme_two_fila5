<article class="flex flex-col shadow my-4">
    ...
    <div class="bg-white flex flex-col justify-start p-6">
        <a href="#" class="text-blue-700 text-sm font-bold uppercase pb-4" aria-label="Vai alla categoria Technology">Technology</a>
        <a href="#" class="text-3xl font-bold hover:text-gray-700 pb-4" aria-label="Vai all'articolo: {{ $getRecord()->question_txt }}">{{ $getRecord()->question_txt }}</a>
        <p class="text-sm pb-3">
            By <a href="#" class="font-semibold hover:text-gray-800" aria-label="Vai al profilo di David Grzyb">David Grzyb</a>, Published on April 25th, 2020
        </p>
    ...
    <div class="bg-white flex flex-col justify-start p-6">
        ...
        <a href="#" class="text-3xl font-bold hover:text-gray-700 pb-4">{{ $getRecord()->question_txt }}</a>
