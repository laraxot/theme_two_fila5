---
title: "Two — mai Filament\*, sempre XotBase*"
type: concept
theme: Two
tags: [two, filament, xotbase, architecture]
created: 2026-07-16
updated: 2026-07-16
qmd: "Two theme filament never extend Filament class XotBase mirror path"
related:
...
Nessuna classe nel tema `Themes/Two` estende una classe `Filament\...` direttamente.
