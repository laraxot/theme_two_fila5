...
> Maturita' stimata: 34% implementato, 66% gap residuo.

## Visione di avanzamento

Questo roadmap traduce il PRD in sequenza di rilascio per **Two**, che nel progetto copre: tema alternativo/legacy con ruolo da chiarire.
