---
title: "Code Quality Improvement Report — Two"
type: report
tags: [code-quality, phpstan, pest, maintainability]
module: "Two"
created: 2026-07-17
updated: 2026-07-17
qmd: "code quality baseline PHPStan Pest strict types Laraxot Two"
story: STORY-001
issues:
...
# Code Quality Improvement Report — Two
...
| Indicatore | Valore |
|---|---:|
| File PHP applicativi/database/route | 1 |
| File di test PHP | 0 |
| Rapporto test/file PHP | 0% |
| Candidati senza strict types | 1 |
...
Dalla cartella laravel/:
    ...
    ./vendor/bin/phpstan analyse Themes/Two --memory-limit=-1
    ./vendor/bin/pest Themes/Two/tests
